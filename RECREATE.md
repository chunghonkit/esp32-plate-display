...
3. Once on WiFi → connect MQTT → subscribe to topic → render incoming plate text — stays visible until the next detection replaces it. Status LED dot: green = connected, light grey = disconnected.
